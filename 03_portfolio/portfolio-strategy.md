...
- 기술 중심: Java 21, Spring Boot 3.5, JPA/H2 검증 구성, 로컬 오픈웨이트 LLM gateway, 고정 정책 검색 typed tool
...
- LLM은 DB, 임의 URL 또는 승인 상태에 직접 접근하지 않음
- 쓰기 도구는 고정 allowlist와 JSON Schema 사용
...
|---|---|---|
| OpsMate Local | Agent, 고정 정책 검색 typed tool 오케스트레이션, 승인 통제, 로컬 모델 장애 처리 | 과거 회사 시스템의 운영 성과 |
